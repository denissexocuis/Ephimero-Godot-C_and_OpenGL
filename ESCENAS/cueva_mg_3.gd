...
func open_c_program():
	# ruta del programa
	var command = "/home/denissexocuis/Documentos/folder-master/master/Graficacion_Computadora/Trabajos/Éphimero. Game/Minigames/MG3"
	
	# ruta de la textura
	var arguments = []  # El programa C debe esperar este argumento
